...
public class OnePlayer extends Jeu{
        // The 'world' : Labyrinth
        ...
        public void addPlayers() {
            ...
            players[0] = new Player("Joueur 1", new Pawn(ConstantesLabyrinth.RESSOURCES.THEO), new Position(8,0), tray);
            players[1] = new Player("Joueur 2", new Pawn(ConstantesLabyrinth.RESSOURCES.LEA), new Position(8, NBRE_CASES-1), tray);
         ...
         */
        public void movePlayer(ConstantesLabyrinth.DIRECTIONS d) {
            unHighlightAll();
